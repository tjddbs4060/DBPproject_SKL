<?php
	...
	session_start();
	$index = $_GET['index'];
	$query_cheer = "select sp.sup_index from schedule as s, support as sp where sp.sch_index = ".$index." and sp.id ='".$_SESSION['userid']."' and sp.flag = 'true'";
	$result_cheer = mysql_query($query_cheer);
	if(!mysql_num_rows($result_cheer)) {
		$query_cheer_add = "insert into support(sch_index, id, flag) values(".$index.", '".$_SESSION['userid']."', 'true')";
